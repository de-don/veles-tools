...
- [ ] ⚠️ в аналитике на графиках зум сбрасывается раз в несколько секунд
- [ ] Кнопка "выбрать все" в таблице 
- [ ] Сортировка групп бектестов в дропдаунах по дате создания
- [ ] Пагинация на бектестах по умолчанию 100, и сохранение выбора пользователя
- [ ] Макс просадка считается неправильно

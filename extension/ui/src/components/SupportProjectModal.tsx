        ...
        () => [
            {
                ...
                content: (
                    <div className="support-modal__tab">
                        <p>
                            Можно отправить любую сумму в любой криптовалюте (USDT, USDC, ETH, WBTC, DAI, и т.д.)
                            на протоколе Ethereum (ERC-20) — в любой совместимой сети
                            (например, Ethereum Mainnet, Arbitrum, Base и др.).
                        </p>
                        <div className="support-modal__address-block">
                            ...
                            <div className="support-modal__address-row">
                                <input
                                    ...
                                    aria-readonly="true"
                                />
                                <button type="button" className="button button--ghost support-modal__copy-button"
            ...
            },
            {
                ...
                content: (
                    <div className="support-modal__tab">
                        <p>
                            Если удобнее воспользоваться Buy Me a Coffee, можно оставить любое пожертвование и добавить
                            сообщение команде. Это быстрый способ сказать спасибо.
                        </p>
                        <a className="support-modal__link" href={BUY_ME_A_COFFEE_URL} target="_blank"
        ...
        >
            <div className="support-modal">
                <p className="support-modal__intro">
                    Этот проект — опенсорс и развивается в моё свободное время. Если расширение делает твою работу проще
                    — ты всегда можешь помочь ему расти!
                </p>
                <p className="support-modal__intro">
                    Любая поддержка мотивирует развивать новые функции и улучшать стабильность. Поддержка абсолютно
                    добровольная и может быть любой суммы ❤️
                </p>

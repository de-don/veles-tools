...
const faqItems = [
  {
    ...
    answer:
      'Veles Tools работает через открытую вкладку veles.finance. Убедитесь, что вкладка активна и не выгружена браузером, затем нажмите «Обновить» в боковой панели. При необходимости перезагрузите саму вкладку veles.finance.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Veles Tools обновляется автоматически через магазин расширений вашего браузера. Убедитесь, что включены автоматические обновления для расширений.',
  },
  {
